 ...
 * @author nothisboy
 */
public class ParentLayoutOfNestedViewPager extends LinearLayout {
    private ViewPager childViewPager;

    public ParentLayoutOfNestedViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ParentLayoutOfNestedViewPager(Context context) {
        super(context);
    }
